...
cookieScriptDomain = "wheezy.com", 
cookieScriptReadMore = "https://fr.wikipedia.org/wiki/Cookie_(informatique)",
cookieId="e0f4680760198d0fcf6b0bc7fa0fdedd",
cookieScriptDebug = 0,
cookieScriptCurrentUrl=window.location.href ,
cookieScriptTitle= '<h4 id="cookiescript_header">Ce site utilise des cookies</h4>',
cookieScriptDesc= "Ce site utilise des cookies, afin d'am\u00e9liorer, votre exp\u00e9rience.<br \/>\r\nEn utilisant ce site, vous acceptez nos cookies, en accord avec notre politique de cookies.<br \/>",
cookieScriptAccept='J\'accepte',
cookieScriptMore='En savoir plus',
cookieScriptCopyrights='J\'accepte',
...
InjectCookieScript = function () {
    ...
    cookieQuery(function () {
		/*if (window!=window.top) { cookieScriptWindow=window.parent.document }	else */
